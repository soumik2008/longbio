...
try:
    ...
    class Data:
        ...
        def SerializeToString(self):
            # Simplified serialization for Vercel
            return f"field_2:{self.field_2},field_8:{self.field_8},field_9:{self.field_9}".encode()
...
def update_freefire_bio(jwt_token, bio_text):
    ...
    try:
        ...
        return {
            ...
            "message": "Connection to Free Fire server timed out"
        }
...
def home():
    return jsonify({
        ...
        "deployment": "Vercel/Termux compatible"
    })
...
def not_found(error):
    return jsonify({
        ...
        "available_endpoints": ["/", "/docs", "/health", "/update_bio", "/update_bio_post"]
    }), 404
...
if __name__ == '__main__':
    ...
    if os.environ.get('VERCEL_ENV'):
        # Vercel deployment - don't run the server
        print("Running on Vercel serverless environment")
    else:
        # Local or Termux deployment
        print("=" * 50)
        print("Free Fire Bio Update API")
        print("=" * 50)
        print("Server starting...")
        print("Local URL: http://127.0.0.1:5000")
        print("Network URL: http://$(hostname -I | awk '{print $1}'):5000")
        print("\nExample usage:")
